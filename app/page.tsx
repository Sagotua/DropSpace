        ...
        <div className="container mx-auto relative">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="space-gradient border-slate-700 hover:border-gray-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-gray-500/20 group">
                <CardHeader className="relative overflow-hidden">
                ...
                <CardContent>
                  <Button
                    className="w-full bg-transparent border-slate-600 text-white hover:bg-slate-800 hover:border-gray-500 transition-all duration-300"
                    variant="outline"
                  >
                    Почати тест
                  </Button>
              ...
              <Card className="space-gradient border-blue-500 relative hover:border-blue-400 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30 group">
                ...
                <CardContent>
                  <Button className="w-full cosmic-glow hover:scale-105 transition-transform duration-300">
                    Обрати план
                  </Button>
                </CardContent>
              </Card>

              <Card className="space-gradient border-slate-700 hover:border-yellow-500/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/20 group">
                <CardHeader className="relative overflow-hidden">
                ...
                <CardContent>
                  <Button
                    className="w-full bg-transparent border-slate-600 text-white hover:bg-slate-800 hover:border-yellow-500 transition-all duration-300"
                    variant="outline"
                  >
                    Обрати план
                  </Button>
